...
import { deleteProduct, getAllProducts, getApprovedProducts, updateProductStatus } from '../../../store/actions/productActions';
...
const PendingProducts = () => {
  ...
  const getAllSellers = async () => {
    dispatch(getAllProducts()).then((res) => {
        ...
        const filteredProducts = res.data.data.filter(product => !product.status);
  ...
  const handleApprove = (productId) => {
    ...
    dispatch(updateProductStatus(productId, false)).then(() => {
